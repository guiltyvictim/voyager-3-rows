...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(6,KC_TAB),   LT(2,KC_ENTER), KC_TRANSPARENT,                                 KC_TRANSPARENT, LT(4,KC_SPACE), KC_F24,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
