...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Q,           TD(DANCE_0),    LT(7,KC_M),     LT(6,KC_C),     MEH_T(KC_V),                                    MEH_T(KC_K),    KC_P,           TD(DANCE_1),    TD(DANCE_2),    KC_F24,         KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_Z,           KC_X,           LT(7,KC_C),     LT(6,KC_V),     MEH_T(KC_B),                                    MEH_T(KC_N),    KC_M,           TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),    KC_TRANSPARENT, 
